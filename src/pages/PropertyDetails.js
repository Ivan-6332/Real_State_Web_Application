...
// Import Helmet for setting up Content Security Policy
...
const PropertyDetails = () => {
  ...
  return (
    <>
      {/* Helmet for setting up Content Security Policy for development */}
      <Helmet>
        <meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' https://maps.googleapis.com; style-src 'self' 'unsafe-inline'; img-src 'self' data:; connect-src 'self'; font-src 'self';" />
      </Helmet>
